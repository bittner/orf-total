...
Item {
    ...
    property int hintSize: units.gu(4)
    ...
    property real actionButtonDistance:  3 * hintSize
...
//          text: ""
                    anchors {
                        ...
                        topMargin: !modelData.top ? units.gu(1) : undefined
                        bottom: modelData.top ? icon.top : undefined
                        bottomMargin: modelData.top ? units.gu(1) : undefined
